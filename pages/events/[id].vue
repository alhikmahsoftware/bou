<template>
  <div :style="{ backgroundImage:imageUrl,backgroundSize: 'cover', backgroundPosition: 'center', minHeight: '100vh'}" class="bg-no-repeat pb-20 relative min-h-[100vh]">
    <div
      class="md:w-[80%] lg:w-[70%] xl:w-[60%] 2xl:w-[50%] mx-auto pt-[20vh] px-2 md:px-[unset] relative z-10"
    >
      <h2 class="text-center text-2xl font-bold lg:text-4xl text-lightblue">
        EVENT
      </h2>

      <div class="mt-16 rounded relative bg-white">
...
import { newsAndEventsData } from "../../data/events-news-data";
