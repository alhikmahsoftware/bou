            ...
            <div v-else>
                <div class="overflow-x-auto">
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            <tr class="border-b dark:border-gray-700" v-for="(item, index) in getSubjectData"
                                :key="index">
                                <td scope="row"
                                ...
                                <td class="px-4 py-3">
                                    <div
                                        ...
                                        <ul class="py-1 text-sm">
                                            <li>
                                                <nuxt-link :to="`/dashboard/create-subject/${item.id}`"
...
import { storeSubject } from "../../data/dashboard/class-routine-api/store-subject";
import { deleteSubject } from "../../data/dashboard/class-routine-api/delete-subject";
...
const handleSubmit = async () => {
    ...
    try {
        const result = await storeSubject(form);
