                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                ...
                                <th scope="col" class="px-4 py-3">Fax</th>
                                <th scope="col" class="px-4 py-3">Email</th>
                                <th scope="col" class="px-4 py-3">Actions</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr class="border-b dark:border-gray-700" v-for="(item, index) in getContactUSData"
                                :key="index">
                                <td scope="row"
                                ...
                                <td class="px-4 py-3">
                                    <div
                                        ...
                                        <ul class="py-1 text-sm">
                                            <li>
                                                <nuxt-link :to="`/dashboard/create-contact/${item.id}`"
...
import { storeContactUS } from "../../data/dashboard/contact-us-api/store";
import { deleteContactUS } from "../../data/dashboard/contact-us-api/delete";
...
async function fetchData() {
    try {
        loading.value = true;
        getContactUSData.value = await getContactUS();
    } catch (error) {
...
const handleSubmit = async () => {
    ...
    try {
        const result = await storeContactUS(form);
